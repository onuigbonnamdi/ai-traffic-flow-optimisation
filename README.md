...
The project uses the Traffic Flow Forecasting Dataset from the UCI Machine Learning Repository — Zhao, L. (2019). [Traffic Flow Forecasting \[Dataset\]](https://doi.org/10.24432/C57897). UCI Machine Learning Repository.
...
Example output is saved as: `outputs/sensor_0_signal_recommendations.csv`
...
### Live App
> _(Add your Streamlit URL here after deploying)_

### Deploy to Streamlit Community Cloud (free)

1. Ensure these files are in the repo root:
   - `app.py`
   - `requirements.txt`
...
3. Set:
   - **Repository:** `onuigbonnamdi/ai-traffic-flow-optimisation`
   - **Branch:** `main`
...
The app runs without the `.mat` file (built-in synthetic data). To use the real UCI dataset, upload the `.mat` file via the sidebar.
